...
from whoownsmass.api.v1.endpoints import owners, metacorps, sites, bgs, munis, parcels, tracts, zctas

router = APIRouter(prefix="/v1")
router.include_router(owners.router, prefix="/owners", tags=["owners"])
router.include_router(metacorps.router, prefix="/metacorps", tags=["metacorps"])
